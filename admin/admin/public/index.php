...
<head>
    ...
    <link rel="stylesheet" href="/admin/resources/css/fontawesome.min.css">
    <!-- https://fontawesome.com/ -->
    <link rel="stylesheet" href="/admin/resources/css/bootstrap.min.css">
    <!-- https://getbootstrap.com/ -->
    <link rel="stylesheet" href="/admin/resources/css/templatemo-style.css">
    <!--
...
<body id="reportsPage">
            ...
            <div class="container h-100">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto h-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/views/product/layout.blade.php">
    ...
    <script src="/admin/resources/js/jquery-3.3.1.min.js"></script>
    <!-- https://jquery.com/download/ -->
    <script src="/admin/resources/js/moment.min.js"></script>
    <!-- https://momentjs.com/ -->
    <script src="/admin/resources/js/Chart.min.js"></script>
    <!-- http://www.chartjs.org/docs/latest/ -->
    <script src="/admin/resources/js/bootstrap.min.js"></script>
    <!-- https://getbootstrap.com/ -->
    <script src="/admin/resources/js/tooplate-scripts.js"></script>
    <script>
