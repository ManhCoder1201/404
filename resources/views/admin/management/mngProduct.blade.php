    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="createproduct" id="add-product-form" enctype="multipart/form-data" method="post" >
            @csrf
              <div class="row">
                  <div class="col-12">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                        ...
                        <select class="form-control category_list" name="supplierID">
                  ...
                  <div class="col-12">
                      <div class="form-group">
                          ...
                          <select class="form-control category_list" name="categoryID">
                  ...
                  <div class="col-12">
                      <div class="form-group">
                          ...
                          <textarea class="form-control" name="productDescription" placeholder="Enter product desc"></textarea>
                      </div>
                  </div>
                  <div class="col-12">
                      <div class="form-group">
  ...
  <div class="modal fade" id="edit_product_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="" id="edit-product-form" enctype="multipart/form-data">
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  <label>Product Name</label>
